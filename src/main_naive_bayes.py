...
model = naive_bayes_model.build_model()
train_reviews, test_reviews = naive_bayes_model.transform_text(train_reviews, test_reviews)

# Hyperparameter tuning
model, best_params, best_score = naive_bayes_model.hyperparameter_tuning(model, train_reviews, train_labels)
print("Best Parameters:", best_params)
print("Best Cross-Validation Score:", best_score)

# Evaluate the model
metrics = naive_bayes_model.evaluate_model(model, test_reviews, test_labels)
...
# Save the model
naive_bayes_model.save_model(model, '../models/naive_bayes_model.pkl')
